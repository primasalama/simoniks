...
<footer class="footer navbar-fixed-bottom" style="height: 130px">
      <div class="container">
        <p class="pull-left" style="margin-left: -50px">Deputi Bidang Koordinasi Sumber Daya Alam dan Jasa<br />
