  ...
  <div class="container-fluid">
    ...
    <header class="header-image">
        <div class="headline">
            ...
            <center>
                <h3>Kebijakan Asisten Deputi</h3>
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                  <a href="<?php echo base_url();?>kebijakan/asdep2" style="text-decoration: none;">
                        <div style="width: 120px;height: 90px;background-color: white;opacity: 0.6;border-radius: 20px;padding-top:30px;">
                            <b>Asdep2</b>
                        </div>
                  </a>
                ...
                <div class="col-sm-3">
                  <a href="<?php echo base_url();?>kebijakan/asdep3" style="text-decoration: none;">
                        <div style="width: 120px;height: 90px;background-color: white;opacity: 0.6;border-radius: 20px;padding-top:30px;">
                            <b>Asdep3</b>
                        </div>
                  </a>
                ...
                <div class="col-sm-3">
                  <a href="<?php echo base_url();?>kebijakan/asdep4" style="text-decoration: none;">
                        <div style="width: 120px;height: 90px;background-color: white;opacity: 0.6;border-radius: 20px;padding-top:30px;">
                            <b>Asdep4</b>
                        </div>
                  </a>
